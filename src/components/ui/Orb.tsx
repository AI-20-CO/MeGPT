...
export default function Orb({
  ...
  useEffect(() => {
    ...
    // Use default premultipliedAlpha (true) for better cross-browser compatibility, especially on iOS Safari
    ...
    // vert and frag are stable string constants defined inside the effect
